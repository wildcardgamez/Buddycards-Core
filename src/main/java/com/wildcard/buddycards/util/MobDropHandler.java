    ...
    public void onLivingDrops(LivingDropsEvent event) {
        ...
        if (event.getSource().getEntity() instanceof Player) {
            ...
            if (entity instanceof ZombifiedPiglin && entity.isBaby()) {
                if (event.getEntityLiving().getRandom().nextFloat() < ConfigManager.zombiePiglinChance.get()) {
                ...
                if (event.getEntityLiving().getRandom().nextFloat() < ConfigManager.zombieVillagerChance.get()) {
                    drops.add(new ItemEntity(world, entity.getX(), entity.getY(), entity.getZ(), new ItemStack(BuddycardsItems.PACK_BASE.get(), 1)));
                }
            }
            else if (entity instanceof Zombie && entity.isBaby()) {
                if (event.getEntityLiving().getRandom().nextFloat() < ConfigManager.zombieChance.get()) {
                    drops.add(new ItemEntity(world, entity.getX(), entity.getY(), entity.getZ(), new ItemStack(BuddycardsItems.PACK_BASE.get(), 1)));
                }
            }
            else if (entity instanceof Villager && entity.isBaby()) {
                if (event.getEntityLiving().getRandom().nextFloat() < ConfigManager.villagerChance.get()) {
                    drops.add(new ItemEntity(world, entity.getX(), entity.getY(), entity.getZ(), new ItemStack(BuddycardsItems.PACK_BASE.get(), 1)));
                }
            }
            else if (entity instanceof Piglin && entity.isBaby()) {
                if (event.getEntityLiving().getRandom().nextFloat() < ConfigManager.piglinChance.get()) {
                    drops.add(new ItemEntity(world, entity.getX(), entity.getY(), entity.getZ(), new ItemStack(BuddycardsItems.PACK_NETHER.get(), 1)));
                }
            }
            else if (entity instanceof Shulker) {
                if (event.getEntityLiving().getRandom().nextFloat() < ConfigManager.shulkerChance.get()) {
