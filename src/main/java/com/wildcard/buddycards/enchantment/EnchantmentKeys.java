...
public class EnchantmentKeys {
    public static ResourceKey<Enchantment> EXTRA_PAGE = ResourceKey.create(Registries.ENCHANTMENT, Buddycards.buddycardsLocation("extra_page"));
    public static ResourceKey<Enchantment> RAPID_RECOVERY = ResourceKey.create(Registries.ENCHANTMENT, Buddycards.buddycardsLocation("rapid_recovery"));
