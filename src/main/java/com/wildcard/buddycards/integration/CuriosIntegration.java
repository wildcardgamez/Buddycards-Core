...
public class CuriosIntegration {
    ...
    public static void setupRenderers() {
        ...
        CuriosRendererRegistry.register(BuddycardsItems.MEDAL_CAVE.get(), () -> new MedalRenderer(getDefaultMedalTexture("buddysteel_medal_cave")));
        ...
        CuriosRendererRegistry.register(BuddycardsItems.LUMINIS_MEDAL_CAVE.get(), () -> new MedalRenderer(getDefaultMedalTexture("luminis_medal_cave")));
        ...
        CuriosRendererRegistry.register(BuddycardsItems.ZYLEX_MEDAL_CAVE.get(), () -> new MedalRenderer(getDefaultMedalTexture("zylex_medal_cave")));
    }
