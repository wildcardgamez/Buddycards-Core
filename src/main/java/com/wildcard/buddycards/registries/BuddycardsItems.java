...
public class BuddycardsItems {
    ...
    //Binders
    public static final RegistryObject<BuddycardBinderItem> BINDER_BASE = ITEMS.register("buddycard_binder_base", () -> new BuddycardBinderItem(DEFAULT_BINDER_PROPERTIES, BASE_SET, new ResourceLocation(Buddycards.MOD_ID, "textures/gui/buddycard_binder_base.png"), false));
    public static final RegistryObject<BuddycardBinderItem> BINDER_NETHER = ITEMS.register("buddycard_binder_nether", () -> new BuddycardBinderItem(DEFAULT_BINDER_PROPERTIES, NETHER_SET, new ResourceLocation(Buddycards.MOD_ID, "textures/gui/buddycard_binder_nether.png"), false));
    public static final RegistryObject<BuddycardBinderItem> BINDER_END = ITEMS.register("buddycard_binder_end", () -> new BuddycardBinderItem(DEFAULT_BINDER_PROPERTIES, END_SET, new ResourceLocation(Buddycards.MOD_ID, "textures/gui/buddycard_binder_end.png"), false));
    public static final RegistryObject<BuddycardBinderItem> BINDER_CAVE = ITEMS.register("buddycard_binder_cave", () -> new BuddycardBinderItem(DEFAULT_BINDER_PROPERTIES, CAVE_SET, new ResourceLocation(Buddycards.MOD_ID, "textures/gui/buddycard_binder_cave.png"), false));
    public static final RegistryObject<BuddycardBinderItem> LARGE_BINDER_BASE = ITEMS.register("large_buddycard_binder_base", () -> new BuddycardBinderItem(DEFAULT_BINDER_PROPERTIES, BASE_SET, new ResourceLocation(Buddycards.MOD_ID, "textures/gui/large_buddycard_binder_base.png"), true));
    public static final RegistryObject<BuddycardBinderItem> LARGE_BINDER_NETHER = ITEMS.register("large_buddycard_binder_nether", () -> new BuddycardBinderItem(DEFAULT_BINDER_PROPERTIES, NETHER_SET, new ResourceLocation(Buddycards.MOD_ID, "textures/gui/large_buddycard_binder_nether.png"), true));
    public static final RegistryObject<BuddycardBinderItem> LARGE_BINDER_END = ITEMS.register("large_buddycard_binder_end", () -> new BuddycardBinderItem(DEFAULT_BINDER_PROPERTIES, END_SET, new ResourceLocation(Buddycards.MOD_ID, "textures/gui/large_buddycard_binder_end.png"), true));
    public static final RegistryObject<BuddycardBinderItem> LARGE_BINDER_CAVE = ITEMS.register("large_buddycard_binder_cave", () -> new BuddycardBinderItem(DEFAULT_BINDER_PROPERTIES, CAVE_SET, new ResourceLocation(Buddycards.MOD_ID, "textures/gui/large_buddycard_binder_cave.png"), true));
    //Deckboxes
    ...
    public static final RegistryObject<BlockItem> GRADER = ITEMS.register("grader", () -> new DescriptionBlockItem(BuddycardsBlocks.GRADER.get(), DEFAULT_PROPERTIES));
    ...
    public static final RegistryObject<BlockItem> ANDESITE_CARD_STAND_ITEM = ITEMS.register("andesite_card_stand", () -> new BlockItem(BuddycardsBlocks.ANDESITE_CARD_STAND.get(), DEFAULT_PROPERTIES));
    public static final RegistryObject<BlockItem> DIORITE_CARD_STAND_ITEM = ITEMS.register("diorite_card_stand", () -> new BlockItem(BuddycardsBlocks.DIORITE_CARD_STAND.get(), DEFAULT_PROPERTIES));
    public static final RegistryObject<BlockItem> GRANITE_CARD_STAND_ITEM = ITEMS.register("granite_card_stand", () -> new BlockItem(BuddycardsBlocks.GRANITE_CARD_STAND.get(), DEFAULT_PROPERTIES));
    public static final RegistryObject<BlockItem> SANDSTONE_CARD_STAND_ITEM = ITEMS.register("sandstone_card_stand", () -> new BlockItem(BuddycardsBlocks.SANDSTONE_CARD_STAND.get(), DEFAULT_PROPERTIES));
    public static final RegistryObject<BlockItem> RED_SANDSTONE_CARD_STAND_ITEM = ITEMS.register("red_sandstone_card_stand", () -> new BlockItem(BuddycardsBlocks.RED_SANDSTONE_CARD_STAND.get(), DEFAULT_PROPERTIES));
    public static final RegistryObject<BlockItem> PRISMARINE_CARD_STAND_ITEM = ITEMS.register("prismarine_card_stand", () -> new BlockItem(BuddycardsBlocks.PRISMARINE_CARD_STAND.get(), DEFAULT_PROPERTIES));
    public static final RegistryObject<BlockItem> CALCITE_CARD_STAND_ITEM = ITEMS.register("calcite_card_stand", () -> new BlockItem(BuddycardsBlocks.CALCITE_CARD_STAND.get(), DEFAULT_PROPERTIES));
    public static final RegistryObject<BlockItem> TUFF_CARD_STAND_ITEM = ITEMS.register("tuff_card_stand", () -> new BlockItem(BuddycardsBlocks.TUFF_CARD_STAND.get(), DEFAULT_PROPERTIES));
    public static final RegistryObject<BlockItem> DRIPSTONE_CARD_STAND_ITEM = ITEMS.register("dripstone_card_stand", () -> new BlockItem(BuddycardsBlocks.DRIPSTONE_CARD_STAND.get(), DEFAULT_PROPERTIES));
    public static final RegistryObject<BlockItem> BASALT_CARD_STAND_ITEM = ITEMS.register("basalt_card_stand", () -> new BlockItem(BuddycardsBlocks.BASALT_CARD_STAND.get(), DEFAULT_PROPERTIES));
    //Booster Box Items
    ...
    public static final RegistryObject<Item> PERFECT_BUDDYSTEEL_HOE = ITEMS.register("perfect_buddysteel_hoe", () -> new HoeItem(BuddycardsToolTier.PERFECT_BUDDYSTEEL,-2, -1F, RARE_TOOL_PROPERTIES));
    ...
    public static final RegistryObject<Item> TRUE_PERFECT_BUDDYSTEEL_HOE = ITEMS.register("true_perfect_buddysteel_hoe", () -> new HoeItem(BuddycardsToolTier.TRUE_PERFECT_BUDDYSTEEL,-3, -1F, RARE_TOOL_PROPERTIES));
